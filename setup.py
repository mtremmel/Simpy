...
#      package_data={'nbdpt':['data/mf_planck13.dat',
 #                            'data/mf_wmap3.dat',
  #                           'data/mf_wmap7.dat']},
      package_data={'Simpy':['default_tdyne_data.pkl'],
                    'Simpy/BlackHoles':['data/QSOdata/M1450z5_McGreer13.dat',
		    ...
		    'Simpy/Stars':['data/GasFrac/M1450z5_McGreer13.dat',
                    ...
                    'data/QuenchFraction/Bluck16_Mvir.csv',
                    'data/QuenchFraction/Bluck16_Mstar.csv']},
