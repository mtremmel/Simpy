...
def cosmicSFH(sim, style, lw=3, bins=50, zrange=None, label=None, ret_hist=True,xlog=False,ylog=False,
	...
	if plotdata is True:
		...
		if xlog is True:
			...
			plotting.plt.scatter(np.array(dat.duncan_z)+1, 10**dat.duncan_sf, color='k', marker='D', label='Duncan+ 14', s=100)
			...
			plotting.plt.scatter(dat.duncan_z, 10**dat.duncan_sf, color='k', marker='D', label='Duncan+ 14', s=100)
